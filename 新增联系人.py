...
#
# # 进入我的联系人
driver.get('http://192.168.20.61/contact/myContact')

# 打开 Excel 文件
wb = openpyxl.load_workbook('D:\desk\联系人信息.xlsx')
...
for row in range(start_row, sheet1_max_row + 1):
    # 点击新增
    button_click("/html/body/div[1]/section/div[2]/div/div[1]/div/section/div[1]/div/div/form/div[4]/div/button[3]")
